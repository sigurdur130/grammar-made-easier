  ...
  return (
    <div className="relative w-full sm:w-auto flex justify-center" style={{ minWidth }}>
      ...
      {baseForm && (
        <label
          className={`
            absolute pointer-events-none transition-all duration-200 ease-out z-10 left-0
            ${shouldFloat
              ? "top-0 -translate-y-[90%] translate-x-0 text-xs scale-90 text-muted-foreground bg-background px-1"
              : "top-1/2 -translate-y-1/2 translate-x-1/2 text-base md:text-lg text-muted-foreground/60"
            }
